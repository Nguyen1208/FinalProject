...
import SearchBar from '../components/serviceDetail/SearchBar';
import RestaurantItem, {
  localRestaurants,
} from '../components/serviceDetail/RestaurantItem';
...
export default function ServiceDetail({ navigation }) {
  ...
  const getRestaurantsFromYelp = () => {
    const yelpUrl =
      'https://api.yelp.com/v3/businesses/search?term=restaurants&location=California';
